...
/**
 * Agent 调用追踪实体
 * 记录每次 Agent 调用的输入、输出、工具调用、token 消耗等信息
 */
@Entity
...
public class AgentTrace {
    ...
    @Column(name = "estimated_cost_yuan")
    private Double estimatedCostYuan = 0.0;

    @Column(name = "call_type", length = 20)
    private String callType = "AGENT";
    ...
    public void setEstimatedCostYuan(Double estimatedCostYuan) {
